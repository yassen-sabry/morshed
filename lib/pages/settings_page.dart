      ...
      children: [
        Column(
          children: [
            ...
            ProfileMenu(icon: "assets/icons/User.svg", text: "Privacy", press: () {},
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: ElevatedButton(
        ...
        onPressed: () {},
        child: Row(children: [
           const Icon(UniconsThinline.history, color: AppColors.secondary,),
          const SizedBox(width: 20,),
          Expanded(child: Text(
            "Purchase History",
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: ElevatedButton(
        ...
        onPressed: () {},
        child: Row(children: [
           const Icon(UniconsLine.user_plus, color: AppColors.secondary,),
          const SizedBox(width: 20,),
          Expanded(child: Text(
            "Invite a friend",
            style: Theme.of(context).textTheme.bodyText1,
