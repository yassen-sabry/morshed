...
class _HomePageState extends State<HomePage> {
    ...
    return Scaffold(
        ...
        body: ListView(
          ...
          children: [
            ...
            Center(
                child: Avatar.large(
              url: _Instructors[index].imageUrl,
            )),
                ...
                IntrinsicHeight(
                  child: Row(
                    children: [
                      ...
                      buildDivider(),
                      buildButton(context, "${_Instructors[index].price}\$",
                          "Per/Minute"),
                    ],
                  ),
                ),
  ...
  Widget _listItemBuilder(BuildContext context, int index) {
    return GestureDetector(
      onTap: () => showDialog(
          context: context,
          builder: (context) =>
              _showScreen(context, _Instructors[index], index)),
      child: Column(
        children: [
          Row(children: [
            Column(mainAxisAlignment: MainAxisAlignment.start, children: [
              Avatar.large(url: _Instructors[index].imageUrl),
  ...
  Widget build(BuildContext context) {
    return ListView(padding: EdgeInsets.only(left: 16, right: 30), children: [
      FilterButton(),
      SizedBox(
        height: 30,
      ),
...
class FilterPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Filter the Instructors"),
      ),
      body: ListView(
        shrinkWrap: true,
        children: [
...
class _Field extends State<Field> {
  final notifications = [
    ...
    NotificationSetting(
      title: "Geology Teacher",
    ),
    NotificationSetting(
      title: "Computer Engineer",
    ),
    NotificationSetting(
      title: "Comuter Scientist",
    ),
    NotificationSetting(
      title: "Accountatnt",
    ),
    NotificationSetting(
      title: "Marketer 'Marketing'",
    ),
    NotificationSetting(
      title: "3d Designer",
    ),
...
class _Price extends State<Price> {
  ...
  Widget buildSingleCheckBox1(NotificationSetting notification) =>
      buildCheckBox1(
          notification: notification,
          onClicked: () {
            setState(() {
